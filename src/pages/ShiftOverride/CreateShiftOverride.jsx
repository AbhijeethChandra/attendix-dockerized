...
} from "@/app/rtkQueries/shiftOverrideApi";
...
export const CreateShiftOver = (props) => {
  ...
  //mutations
  const [createApi, createApiRes] = useCreateShiftOverrideMutation();
  const [editApi, editApiRes] = useUpdateShiftOverrideMutation();
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex-1 space-y-3 overflow-y-auto px-5 pb-1">
          <SearchBar
            required
            label="Office"
          ...
          <CommonInput
            ...
            label="Override Date"
            name="overrideDate"
            value={details.overrideDate}
            onChange={(date) =>
              handleDateChange({ name: "overrideDate", date })
            }
          />
          <CommonInput
            required
